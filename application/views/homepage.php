<?php echo form_open('handle/job'); ?>
    <div class="row">
        ...
        <div class="job-category form-row col-12 col-m-12">
            <label class="col-2 col-m-12" for="job_category">Job Field</label>
            <?php echo form_dropdown(
                array(
                    'name'  => 'job_category',
                    'id'    => 'jobSelectBox',
                    'class' => 'col-10 col-m-12',
        ...
        <div class="job-title form-row <col-12 col-m-12">
            <label class="col-2 col-m-12" for="job_title" class='col-10 col-m-12'>Job Title</label>
            <?php echo form_input(
                array(
                    'name' => 'job_title',
                    'class' => 'col-10 col-m-12',
        ...
        <div class="company form-row col-12 col-m-12">
            <label class="col-2 col-m-12" for="company">Company Name</label>
            <?php echo form_input(
                array(
                    'name' => 'company',
                    'class' => 'col-10 col-m-12',
        ...
        <div class="job-desc form-row col-12 col-m-12">
            <label class="col-2 col-m-12" for="job_desc">Job Description</label>
        ...
        <div class="job-require form-row col-12 col-m-12">
            <label class="col-2 col-m-12" for="job_require">Job Requirements</label>
            <?php echo form_textarea(
                array(
                    'name' => 'job_require',
                    'class' => 'col-10 col-m-12',
        ...
        <div class="salary form-row col-12 col-m-12">
            <label class="col-2 col-m-12" for="salary">Salary</label>
            <?php echo form_input(
                array(
                    'name' => 'salary',
                    'class' => 'col-10 col-m-12',
        ...
        <div class="benefit form-row col-12 col-m-12">
            <label class="col-2 col-m-12" for="benefit">Benefits</label>
            <?php echo form_textarea(
                array(
                    'name' => 'benefit',
                    'class' => 'col-10 col-m-12',
        ...
        <div class="job-contact-submit form-row col-12 col-m-12">
            <label class="col-2 col-m-12" for="job_contact">Contact to CV Submission</label>
            <?php echo form_textarea(
                array(
        ...
        <div class="deadline form-row col-12 col-m-12">
            <label class="col-2 col-m-12" for="deadline">Deadline</label>
            <?php echo form_input(
                array(
                    'type' => 'date',
                    'name' => 'deadline',
        ...
        <div class="job-contact-contributor form-row col-12 col-m-12">
            <label class="col-2 col-m-12" for="job_contact">Contact to Contributor</label>
            <?php echo form_textarea(
                array(
        ...
        <div class="job-image form-row col-12 col-m-12">
            <label class="col-2 col-m-12" for="job_image">Image</label>
