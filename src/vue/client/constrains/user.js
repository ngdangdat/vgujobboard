...
const PASSWORD_RESET_FALIED = 'PASSWORD_RESET_FALIED';

export const PASSWORD_RESET_ACTIONS = {
    PASSWORD_RESET_REQUEST,
    PASSWORD_RESET_PENDING,
    PASSWORD_RESET_SUCCESS,
    PASSWORD_RESET_FALIED,
};

const PASSWORD_CHANGE_REQUEST = 'PASSWORD_CHANGE_REQUEST';
const PASSWORD_CHANGE_SUCCESS = 'PASSWORD_CHANGE_SUCCESS';
const PASSWORD_CHANGE_PENDING = 'PASSWORD_CHANGE_PENDING';
const PASSWORD_CHANGE_FAILED = 'PASSWORD_CHANGE_FAILED';

export const PASSWORD_CHANGE_ACTIONS = {
